...
tabBox(title = "Opciones",width = 8,tabPanel("Adams",width = 400,
...
legend(x = "topright", legend=c("Susceptibles", "Infectados aproximado", "infectados real"), col=c("black", "blue", "red"), lty=rep(1, 2))  })
...
legend(x = "topright", legend=c("Susceptibles", "Infectados"), col=c("black", "blue"), lty=rep(1, 2)) })
